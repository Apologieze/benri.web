...
const Feature: FC<Props> = ({ imgUrl, align, className = "", heading, text }) => {
  return (
    <div className={
      ...
      <div className={`relative max-w-md p-2 md:max-w-lg lg:max-w-xl xl:max-w-2xl ${align === "left" ? "mr-5 rounded-r-md bg-gradient-to-br from-secondary to-primary sm:mr-2" : "ml-5 rounded-l-md bg-gradient-to-br from-primary to-secondary sm:ml-2"}`}>
